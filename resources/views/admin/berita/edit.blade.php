                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" value="{{ $berita->isi }}" name="isi" id="content-textarea" hidden
                            ...
                            <div class="mb-3">
                                <div class="card shadow-none border text-center ">
                                    <label class="form-label border-dashed cursor-pointer" id="label"
                                        style="border-radius:10px;" for="imageFile">Upload Gambar
                                ...
                                <select class="form-select" name="kategori_id" id="kategoriSelect">
                                    @foreach ($kategori as $itemk)
                                        @if ($itemk->id === $berita->kategori_id)
                                            <option value="{{ $itemk->id }}" selected>{{ $itemk->nama_kategori }}</option>
                                        @else
